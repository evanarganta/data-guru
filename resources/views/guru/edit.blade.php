...
@section('title', 'Edit '.$guru->nama)

@section('content')
    <div class="mx-auto max-w-xl">
        <a href="{{ route('guru.show', $guru) }}" class="mb-4 inline-flex items-center gap-1.5 text-xs text-zinc-500 transition hover:text-zinc-300">
        ...
        <div class="rounded-xl border border-zinc-800 bg-zinc-900/40 p-6">
            <h1 class="mb-5 border-b border-zinc-800 pb-4 text-base font-semibold text-white">Edit {{ $guru->nama }}</h1>
